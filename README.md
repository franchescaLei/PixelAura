...
Tech Stack
LayerTechnologyLanguageKotlinPlatformAndroid (Native)AuthenticationFirebase AuthenticationDatabaseCloud Firestore (NoSQL)Image HostingImgur APIReal-time UpdatesFirestore Snapshot Listeners
